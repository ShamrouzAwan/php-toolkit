...
NT.backToExplorer = function() {
    ...
    document.getElementById('nt-related').style.display = 'none';
    document.getElementById('nt-explorer').style.display = '';
    document.getElementById('nt-explorer').scrollIntoView({behavior:'smooth',block:'start'});
};
...
NT.analyze = async function() {
    ...
    document.getElementById('nt-dashboard').style.display = '';
